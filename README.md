...
**Note:** Mod loading functionality has been moved to a separate project named [Twofold](https://github.com/spitfirex86/Twofold), and is no longer included in Ray2Fix.
...
- Recommended: The [GOG.com version](https://www.gog.com/game/rayman_2_the_great_escape) of the game installed using the standalone installer.
    - GOG Galaxy is not recommended, but should work.
